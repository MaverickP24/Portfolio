...
<div className=" mix-blend-multiply m-4 mb-1 p-6 rounded-4xl h-[60vw] w-full bg-gradient-to-r from-black to-transparent z-10  top-0 left-0  absolute ">
        <div id='page1-in' className="absolute top-0 left-0 shadow-2xl shadow-gray-700 h-[60vw] w-[98vw] bg-[url(https://i.imgur.com/8SxDB1S.jpeg)] bg-[length:120%] bg-left py-10 px-12 rounded-4xl">
            ...
            <div className=" absolute text-zinc-800 right-[2.5%] top-[50%] flex flex-col items-center justify-end z-1000 gap-5 ">
                ...
                <a href="https://www.instagram.com/pratyush.py3/" target="_blank" className=' h-[2.5vw] w-[2.5vw]  border-2 p-2 rounded-xl hover:bg-amber-50 transition-normal duration-750'>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
...
{/* Main Texts */}
            {/* <Tilttext/> */}
            <div className="absolute left-0 top-0 h-[60vw] w-full flex flex-col justify-evenly items-start mx-[6vw] z-100 ">
                <div></div>
                <div></div>
                <div id='tiltDiv' ref={tiltref} className=''>
