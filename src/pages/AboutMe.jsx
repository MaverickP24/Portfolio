        ...
        <div className="details flex flex-col gap-5">
            <div className="aboutme flex flex-row gap-6 mt-10 relative">
                <div className="name border-1 rounded-4xl border-zinc-400 w-[40vw] h-[15vw] relative">
                    ...
                    <div className="github h-8 w-8 object-cover absolute right-3 top-3 text-zinc-800">
            ...
            <div className="aboutme flex flex-row gap-6 ">
                <div className="CV border-1 relative rounded-4xl border-zinc-400 w-[25vw] h-[15vw] bg-black flex flex-col items-center font-[anzo3] overflow-y-hidden group ">
                    ...
                    <div className="h-[20px]  z-30  absolute bottom-10 opacity-0 group-hover:opacity-[100%]  transition-all duration-300 "><a href="src/assets/Resume.pdf" download="Pratyush-resume.pdf" className='text-white px-4 py-2 rounded-3xl bg-emerald-600'>DOWNLOAD CV</a></div>


                    <div className='resume h-[18vw] w-[16vw] bg-emerald-500 rounded-2xl absolute top-25 transition-all duration-300 group-hover:top-4 '><a href="#"><img src="https://i.imgur.com/uOtGkbz.png" className='rounded-[10px]' alt="i" /></a>
